...
import (
	...
	n3wscottv1alpha1 "github.com/n3wscott/task/pkg/apis/n3wscott/v1alpha1"
	...
	v1alpha1 "github.com/n3wscott/task/pkg/client/listers/n3wscott/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.N3wscottV1alpha1().Tasks(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.N3wscottV1alpha1().Tasks(namespace).Watch(options)
			},
		},
		&n3wscottv1alpha1.Task{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *taskInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&n3wscottv1alpha1.Task{}, f.defaultInformer)
}
